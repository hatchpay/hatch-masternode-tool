...
log = logging.getLogger('hmt.db_intf')
    ...
    def create_structures(self):
        try:
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS masternodes(id INTEGER PRIMARY KEY, ident TEXT, status TEXT,"
                        ...
                        " hmt_active INTEGER, hmt_create_time TEXT, hmt_deactivation_time TEXT)")

            cur.execute("CREATE INDEX IF NOT EXISTS IDX_masternodes_HMT_ACTIVE ON masternodes(hmt_active)")
            ...
            cur.execute("CREATE TABLE IF NOT EXISTS proposals(id INTEGER PRIMARY KEY, name TEXT, payment_start TEXT,"
                        ...
                        " f_cached_endorsed INTEGER, object_type INTEGER, is_valid_reason TEXT, hmt_active INTEGER, "
                        " hmt_create_time TEXT, hmt_deactivation_time TEXT, hmt_voting_last_read_time INTEGER,"
            ...
            # has just been sent from hmt wallet or the transaction which appeared in the mempool); in this case
