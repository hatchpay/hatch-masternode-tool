...
from hatch_utils import num_to_varint, read_varint_from_file, bip32_path_n_to_string
...
HMT_ENCRYPTED_DATA_PREFIX = b'HMTEF'
...
def read_file_encrypted(file_name: str, ret_attrs: dict, hw_session: HwSessionInfo):
    ...
    try:
        with open(file_name, 'rb') as f_ptr:
            ...
            data = f_ptr.read(len(HMT_ENCRYPTED_DATA_PREFIX))
            if data == HMT_ENCRYPTED_DATA_PREFIX:
                        ...
                        if hw_session.app_config.hw_type == hw_type:
                            ...
                            try:
                                hw_session = HwSessionInfo(get_hw_client_function=_get_client,
                                                           ...
                                                           hatchd_intf=hw_session.hatchd_intf)
