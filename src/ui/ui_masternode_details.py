...
# Form implementation generated from reading ui file '/Users/blogin/Projects/hatch-masternode-tool/src/ui/ui_masternode_details.ui'
#
...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        self.lblHMNTxHash = QtWidgets.QLabel(self.widget_2)
        self.lblHMNTxHash.setMinimumSize(QtCore.QSize(144, 0))
        self.lblHMNTxHash.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lblHMNTxHash.setObjectName("lblHMNTxHash")
        self.horizontalLayout_10.addWidget(self.lblHMNTxHash)
        self.edtHMNTxHash = QtWidgets.QLineEdit(self.widget_2)
        self.edtHMNTxHash.setClearButtonEnabled(True)
        self.edtHMNTxHash.setObjectName("edtHMNTxHash")
        self.horizontalLayout_10.addWidget(self.edtHMNTxHash)
        ...
        self.btnFindHMNTxHash = QtWidgets.QToolButton(self.widget_2)
        self.btnFindHMNTxHash.setObjectName("btnFindHMNTxHash")
        self.horizontalLayout_10.addWidget(self.btnFindHMNTxHash)
        ...
        WdgMasternodeDetails.setTabOrder(self.edtCollateralTxIndex, self.edtHMNTxHash)
        WdgMasternodeDetails.setTabOrder(self.edtHMNTxHash, self.edtOwnerKey)
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.btnShowCollateralPathAddress.setToolTip(_translate("WdgMasternodeDetails", "Show Hatch address for the entered BIP32 path"))
        ...
        self.lblHMNTxHash.setText(_translate("WdgMasternodeDetails", "Protx hash"))
        self.btnCopyProtxHash.setToolTip(_translate("WdgMasternodeDetails", "Copy protx hash to clipboard"))
        self.btnFindHMNTxHash.setToolTip(_translate("WdgMasternodeDetails", "Find HMN TX hash based on the ip/port or collateral tx"))
        self.btnFindHMNTxHash.setText(_translate("WdgMasternodeDetails", "Find"))
