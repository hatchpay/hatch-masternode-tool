...
# Form implementation generated from reading ui file '/Users/blogin/PycharmProjects/HMT-git/src/ui/ui_config_dlg.ui'
#
...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabHatchd = QtWidgets.QWidget()
        self.tabHatchd.setObjectName("tabHatchd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabHatchd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabHatchd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboHatchNetwork = QtWidgets.QComboBox(self.tabHatchd)
        self.cboHatchNetwork.setObjectName("cboHatchNetwork")
        self.cboHatchNetwork.addItem("")
        self.cboHatchNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboHatchNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabHatchd)
        ...
        self.tabWidget.addTab(self.tabHatchd, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Hatch network:"))
        self.cboHatchNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboHatchNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabHatchd), _translate("ConfigDlg", "Hatch network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (HatchCentral.org)"))
