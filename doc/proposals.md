...
Version 0.9.8 of *HMT* introduced functionality for *masternode owners* (MNOs) to review and cast votes on current proposals. In addition to MNOs, this feature is also useful to *proposal owners*, who can use it to track and analyze voting progress on their proposals.
...
![Proposals window](img/hmt-proposals-window.png)
...
![Column selection dialog](img/hmt-proposals-columns.png)
 ...
 * Cast a vote on proposals (if a masternode is configured in *HMT*).
 ...
 * A chart summarizing YES, NO and ABSTAIN vote counts.  
    ![Voting history tab](img/hmt-proposals-voting-history.png)  

    Vote change chart:  
    ![Vote change chart](img/hmt-proposals-vote-change-chart.png)  

    Vote summary chart:  
    ![Vote summary chart](img/hmt-proposals-vote-summary-chart.png)

### Casting votes

In the main proposals list, select the proposal(s), you'd like to vote on.

> Note: from HMT v0.9.18 you can select and vote on multiple proposals
...
![Vote tab](img/hmt-proposals-vote.png)
...
![Vote tab](img/hmt-proposals-vote-2.png)
