...
2. On the running Linux system, download the latest [Hatch Masternode Tool archived binary](https://github.com/hatchpay/hatch-masternode-tool/releases) (.tar.gz) from the project page, or copy the file to the system in some other way.
...
**A copy of the commands to create the udev rules required by hardware wallets supported by HMT appears below**
