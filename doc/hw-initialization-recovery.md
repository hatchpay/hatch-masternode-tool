 ...
 * [Hardware wallet initialization and recovery in HMT](#hardware-wallet-initialization-and-recovery-in-hmt)
 ...
 * [Running HMT on an offline Linux system](hw-initr-live-cd-linux.md)
...
## Hardware wallet initialization and recovery in HMT

All functionality described in this chapter is available in the `Hardware wallet initialization/recovery` dialog, launched from the `Tools` menu of HMT. The application will guide you through the steps using a standard wizard-style dialog, where interaction with the user is divided into separate steps.
